...
#define _INCFG_IPV4_ADDR_STRSZ_MAX  INCFG_IPV4_ADDR_STRSZ_MAX
#define _INCFG_IPV4_ADDR_PACKSZ_MIN INCFG_IPV4_ADDR_PACKSZ
#define _INCFG_IPV4_ADDR_PACKSZ_MAX INCFG_IPV4_ADDR_PACKSZ

#else  /* !defined(CONFIG_INCFG_IPV4) */

#define _INCFG_IPV4_ADDR_STRSZ_MAX  (0U)
#define _INCFG_IPV4_ADDR_PACKSZ_MIN (UINT_MAX)
#define _INCFG_IPV4_ADDR_PACKSZ_MAX (0U)

#endif /* defined(CONFIG_INCFG_IPV4) */

#if defined(CONFIG_INCFG_IPV6)

#define _INCFG_IPV6_ADDR_STRSZ_MAX  INCFG_IPV6_ADDR_STRSZ_MAX
#define _INCFG_IPV6_ADDR_PACKSZ_MIN INCFG_IPV6_ADDR_PACKSZ
#define _INCFG_IPV6_ADDR_PACKSZ_MAX INCFG_IPV6_ADDR_PACKSZ

#else  /* !defined(CONFIG_INCFG_IPV6) */

#define _INCFG_IPV6_ADDR_STRSZ_MAX  (0U)
#define _INCFG_IPV6_ADDR_PACKSZ_MIN (UINT_MAX)
#define _INCFG_IPV6_ADDR_PACKSZ_MAX (0U)

#endif /* defined(CONFIG_INCFG_IPV6) */

#define INCFG_IP_ADDR_STRSZ_MAX \
	STROLL_CONST_MAX(_INCFG_IPV4_ADDR_STRSZ_MAX, _INCFG_IPV6_ADDR_STRSZ_MAX)

#define INCFG_IP_ADDR_STRLEN_MAX \
	(INCFG_IP_ADDR_STRSZ_MAX - 1)

#define INCFG_IP_ADDR_PACKSZ_MIN \
	(INCFG_ADDR_TYPE_PACKSZ + \
	 STROLL_CONST_MIN(_INCFG_IPV4_ADDR_PACKSZ_MIN, \
	                  _INCFG_IPV6_ADDR_PACKSZ_MIN))

#define INCFG_IP_ADDR_PACKSZ_MAX \
	(INCFG_ADDR_TYPE_PACKSZ + \
	 STROLL_CONST_MAX(_INCFG_IPV4_ADDR_PACKSZ_MAX, \
	                  _INCFG_IPV6_ADDR_PACKSZ_MAX))
